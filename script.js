  ...
  setTimeout(function () {
    const intervalId = setInterval(() => {
      if (percent < 9999) {
        ...
        const randomEmoji =
          emojiAkhir[Math.floor(Math.random() * emojiAkhir.length)];
...
function katanimasi2() {
  ...
  new TypeIt("#teks4", {
    strings: [
      "<span style='font-size:17px;line-height:1.5em'>Cukup tau ah kamu<br>ga kangen aku 😡🫵</span>",
      "<span style='font-size:17px;line-height:1.5em'><br><b>Padahal... 🫠</b></span>",
    ],
    startDelay: 10,
    speed: 25,
    cursor: true,
...
function katanimasi3() {
  ...
  new TypeIt("#teks4", {
    strings: Array.from(
      { length: 10 },
      (_, i) => `I Love Youu ${i + 1}% ` + randomEmoji
    ),
    startDelay: 50,
    speed: 10,
    cursor: false,
